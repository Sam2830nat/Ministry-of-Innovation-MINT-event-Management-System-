...
export const cemsColors = {
  ...
  brand: {
    DEFAULT: "#085464",  // deep teal
    hover: "#06404c",
    subtle: "#e6f0f2",    // very faint bg tint
    muted: "#c1d9df",     // softer ring / accent
    foreground: "#ffffff",
  },
  ...
  status: {
    ...
    info:    { bg: "bg-brand dark:bg-brand/10", text: "text-brand dark:text-brand", border: "border-brand dark:border-brand/20", dot: "bg-brand" },
